...
class ProductOrderProvider extends BaseProvider<ProductOrder> {
  ProductOrderProvider() : super('ProductOrders');

  Future<bool> changeOrderStatus(int appointmentId, int status) async {
    try {

      final response = await http.get(
        Uri.parse('${BaseProvider.apiUrl}/ProductOrders/change-status/$appointmentId/${status}'),
