import 'package:wood_track_admin/models/product_order.dart';
...
class ProductOrderListScreen extends StatefulWidget {
  static const String routeName = "productOrders";
  const ProductOrderListScreen({Key? key}) : super(key: key);
...
class _ProductOrderListScreenState extends State<ProductOrderListScreen> {
  final ProductOrderProvider _orderProvider = ProductOrderProvider();
  ...
  Future<void> _showOrderDetails(ProductOrder order) async {
    await showDialog(
      context: context,
      builder: (context) {
        return Dialog(
  ...
  Future<void> _updateOrderStatus(ProductOrder order) async {
    await showDialog(
      context: context,
      builder: (context) {
